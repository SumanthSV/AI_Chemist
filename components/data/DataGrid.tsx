...
export default function DataGrid({ 
  ...
  return (
    <div className="w-full">
      {/* Search and Info */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 bg-gradient-to-r from-slate-50 to-blue-50 rounded-t-lg border-b">
      ...
      {relationshipSuggestions.length > 0 && (
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border-x border-purple-200 p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {relationshipSuggestions.map((suggestion, index) => (
              <div key={index} className="flex items-center gap-2 text-sm bg-white p-3 rounded-lg border border-purple-200">
